...
### Fluent API with Priority

```php
$provider
    ->listen(OrderCreated::class, $sendConfirmation, priority: 10)   // first
    ->listen(OrderCreated::class, $updateInventory, priority: 5)     // second
    ->listen(OrderCreated::class, $logEvent);                        // last (0)
```
